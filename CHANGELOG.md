...
* **deps-dev:** bump the npm-development group across 1 directory with 7 updates ([#107](https://github.com/rmartz/vercel-deploy-scripts/issues/107)) ([4f9b1ff](https://github.com/rmartz/vercel-deploy-scripts/commit/4f9b1ff7dee0eaded78b093d361f9e9f49a2825b))


### BREAKING CHANGES

* **deps-dev:** bump the npm-development group across 1 directory with 7 updates (#107)

# [7.0.0](https://github.com/rmartz/vercel-deploy-scripts/compare/v6.0.0...v7.0.0) (2026-07-21)


### chore

* **deps-dev:** bump the npm-development group with 5 updates ([#102](https://github.com/rmartz/vercel-deploy-scripts/issues/102)) ([fc4606b](https://github.com/rmartz/vercel-deploy-scripts/commit/fc4606b805fce624bd07a113eba8b5dd96922072))


### BREAKING CHANGES

* **deps-dev:** bump the npm-development group with 5 updates (#102)

# [6.0.0](https://github.com/rmartz/vercel-deploy-scripts/compare/v5.2.0...v6.0.0) (2026-07-07)


### chore

* **deps-dev:** bump the npm-development group with 4 updates ([#95](https://github.com/rmartz/vercel-deploy-scripts/issues/95)) ([7cc4cf7](https://github.com/rmartz/vercel-deploy-scripts/commit/7cc4cf73cb7c27398b7e2ffa98c84158b3310a2a))


### BREAKING CHANGES

* **deps-dev:** bump the npm-development group with 4 updates (#95)
